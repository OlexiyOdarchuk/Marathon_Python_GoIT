...
bg = pygame.transform.scale(pygame.image.load('img/background.png').convert(), (WIDTH, HEIGHT))
bg_X1 = 0
bg_X2 = bg.get_width()
bg_move = 3
...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(enemy_size[1]//2, HEIGHT-enemy_size[1]//2), *enemy_size)
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(bonus_size[0]//2, WIDTH//2), -bonus_size[1], *bonus_size)
